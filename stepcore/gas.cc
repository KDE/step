...
STEPCORE_META_OBJECT(GasLJForceErrors, QT_TR_NOOP("GasLJForceErrors"), QT_TR_NOOP("Errors class for GasLJForce"), 0,
    ...
    STEPCORE_PROPERTY_RW(double, rminVariance, QT_TR_NOOP("rminVariance"), QT_TR_NOOP("m"),
...
STEPCORE_META_OBJECT(Gas, QT_TR_NOOP("Gas"), QT_TR_NOOP("Particle gas"), 0, STEPCORE_SUPER_CLASS(ItemGroup),
    ...
    STEPCORE_PROPERTY_R_D(double, rectVolume, QT_TR_NOOP("rectVolume"), STEPCORE_FROM_UTF8("m²"),
                QT_TR_NOOP("Volume of the measureRect"), rectVolume)
    STEPCORE_PROPERTY_R_D(double, rectParticleCount, QT_TR_NOOP("rectParticleCount"), STEPCORE_UNITS_1,
                QT_TR_NOOP("Count of particles in the measureRect"), rectParticleCount)
    STEPCORE_PROPERTY_R_D(double, rectConcentration, QT_TR_NOOP("rectConcentration"), STEPCORE_FROM_UTF8("1/m²"),
                QT_TR_NOOP("Concentration of particles in the measureRect"), rectConcentration)
    STEPCORE_PROPERTY_R_D(double, rectPressure, QT_TR_NOOP("rectPressure"), QT_TR_NOOP("Pa"),
                QT_TR_NOOP("Pressure of particles in the measureRect"), rectPressure)
    STEPCORE_PROPERTY_R_D(double, rectTemperature, QT_TR_NOOP("rectTemperature"), QT_TR_NOOP("K"),
                QT_TR_NOOP("Temperature of particles in the measureRect"), rectTemperature)
    STEPCORE_PROPERTY_R_D(double, rectMeanKineticEnergy, QT_TR_NOOP("rectMeanKineticEnergy"), QT_TR_NOOP("J"),
                QT_TR_NOOP("Mean kinetic energy of particles in the measureRect"), rectMeanKineticEnergy)
    STEPCORE_PROPERTY_R_D(StepCore::Vector2d, rectMeanVelocity, QT_TR_NOOP("rectMeanVelocity"), QT_TR_NOOP("m/s"),
                QT_TR_NOOP("Mean velocity of particles in the measureRect"), rectMeanVelocity)
    STEPCORE_PROPERTY_R_D(double, rectMeanParticleMass, QT_TR_NOOP("rectMeanParticleMass"), QT_TR_NOOP("kg"),
                QT_TR_NOOP("Mean mass of particles in the measureRect"), rectMeanParticleMass)
    STEPCORE_PROPERTY_R_D(double, rectMass, QT_TR_NOOP("rectMass"), QT_TR_NOOP("kg"),
...
STEPCORE_META_OBJECT(GasErrors, QT_TR_NOOP("GasErrors"), QT_TR_NOOP("Errors class for Gas"), 0, STEPCORE_SUPER_CLASS(ObjectErrors),
    ...
    STEPCORE_PROPERTY_R_D(double, rectMeanKineticEnergyVariance, QT_TR_NOOP("rectMeanKineticEnergyVariance"), QT_TR_NOOP("J"),
                QT_TR_NOOP("Variance of mean kinetic energy of particles in the measureRect"), rectMeanKineticEnergyVariance)
    STEPCORE_PROPERTY_R_D(StepCore::Vector2d, rectMeanVelocityVariance, QT_TR_NOOP("rectMeanVelocityVariance"), QT_TR_NOOP("m/s"),
                QT_TR_NOOP("Variance of mean velocity of particles in the measureRect"), rectMeanVelocityVariance)
    STEPCORE_PROPERTY_R_D(double, rectMeanParticleMassVariance, QT_TR_NOOP("rectMeanParticleMassVariance"), QT_TR_NOOP("kg"),
                QT_TR_NOOP("Variance of mean mass of particles in the measureRect"), rectMeanParticleMassVariance)
    STEPCORE_PROPERTY_R_D(double, rectMassVariance, QT_TR_NOOP("rectMassVariance"), QT_TR_NOOP("kg"),
