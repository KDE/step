...
STEPCORE_META_OBJECT(Item, QT_TRANSLATE_NOOP("ObjectClass", "Item"), QT_TR_NOOP("Item"), MetaObject::ABSTRACT, STEPCORE_SUPER_CLASS(Object),
        STEPCORE_PROPERTY_RW(StepCore::Color, color, QT_TRANSLATE_NOOP("ObjectProperty", "color"), STEPCORE_UNITS_NULL, QT_TR_NOOP("Item color"), color, setColor))
...
STEPCORE_META_OBJECT(World, QT_TRANSLATE_NOOP("ObjectClass", "World"), QT_TR_NOOP("World"), 0, STEPCORE_SUPER_CLASS(ItemGroup),
        STEPCORE_PROPERTY_RW_D(double, time, QT_TRANSLATE_NOOP("ObjectProperty", "time"), QT_TR_NOOP("s"), QT_TR_NOOP("Current time"), time, setTime)
        STEPCORE_PROPERTY_RW  (double, timeScale, QT_TRANSLATE_NOOP("ObjectProperty", "timeScale"), STEPCORE_UNITS_1, QT_TR_NOOP("Simulation speed scale"), timeScale, setTimeScale)
        STEPCORE_PROPERTY_RW  (bool, errorsCalculation, QT_TRANSLATE_NOOP("ObjectProperty", "errorsCalculation"), STEPCORE_UNITS_NULL,
