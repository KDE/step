...
STEPCORE_META_OBJECT(RigidBody, QT_TRANSLATE_NOOP("ObjectClass", "RigidBody"), QT_TR_NOOP("Generic rigid body"), 0, STEPCORE_SUPER_CLASS(Item) STEPCORE_SUPER_CLASS(Body),
        ...
        STEPCORE_PROPERTY_RW_D(double, angle, QT_TRANSLATE_NOOP("ObjectProperty", "angle"), QT_TR_NOOP("rad"), QT_TR_NOOP("Rotation angle"), angle, setAngle)
        ...
        STEPCORE_PROPERTY_RW(double, mass, QT_TRANSLATE_NOOP("ObjectProperty", "mass"), QT_TR_NOOP("kg"), QT_TR_NOOP("Total mass of the body"), mass, setMass)
        ...
        STEPCORE_PROPERTY_RWF(double, angularMomentum, QT_TRANSLATE_NOOP("ObjectProperty", "angularMomentum"), STEPCORE_FROM_UTF8("kg m² rad/s"), QT_TR_NOOP("angular momentum"),
...
STEPCORE_META_OBJECT(RigidBodyErrors, QT_TRANSLATE_NOOP("ObjectClass", "RigidBodyErrors"), QT_TR_NOOP("Errors class for RigidBody"), 0, STEPCORE_SUPER_CLASS(ObjectErrors),
        ...
        STEPCORE_PROPERTY_RW_D(double, angleVariance, QT_TRANSLATE_NOOP("ObjectProperty", "angleVariance"), QT_TR_NOOP("rad"),
        ...
        STEPCORE_PROPERTY_RW_D(double, angularVelocityVariance, QT_TRANSLATE_NOOP("ObjectProperty", "angularVelocityVariance"), QT_TR_NOOP("rad/s"),
        ...
        STEPCORE_PROPERTY_R_D(StepCore::Vector2d, forceVariance, QT_TRANSLATE_NOOP("ObjectProperty", "forceVariance"), QT_TR_NOOP("N"), QT_TR_NOOP("force variance"), forceVariance)
        STEPCORE_PROPERTY_R_D(double, torqueVariance, QT_TRANSLATE_NOOP("ObjectProperty", "torqueVariance"), QT_TR_NOOP("N m"), QT_TR_NOOP("torque variance"), torqueVariance)
        ...
        STEPCORE_PROPERTY_RWF(double, kineticEnergyVariance, QT_TRANSLATE_NOOP("ObjectProperty", "kineticEnergyVariance"), QT_TR_NOOP("J"),
...
STEPCORE_META_OBJECT(Disk, QT_TRANSLATE_NOOP("ObjectClass", "Disk"), QT_TR_NOOP("Rigid disk"), 0, STEPCORE_SUPER_CLASS(RigidBody),
        STEPCORE_PROPERTY_RW(double, radius, QT_TRANSLATE_NOOP("ObjectProperty", "radius"), QT_TR_NOOP("m"), QT_TR_NOOP("Radius of the disk"), radius, setRadius))
...
STEPCORE_META_OBJECT(Box, QT_TRANSLATE_NOOP("ObjectClass", "Box"), QT_TR_NOOP("Rigid box"), 0, STEPCORE_SUPER_CLASS(BasePolygon),
        STEPCORE_PROPERTY_RW(StepCore::Vector2d, size, QT_TRANSLATE_NOOP("ObjectProperty", "size"), QT_TR_NOOP("m"), QT_TR_NOOP("Size of the box"), size, setSize))
...
STEPCORE_META_OBJECT(Polygon, QT_TRANSLATE_NOOP("ObjectClass", "Polygon"), QT_TR_NOOP("Rigid polygon body"), 0, STEPCORE_SUPER_CLASS(BasePolygon),
        STEPCORE_PROPERTY_RW(Vector2dList, vertexes, QT_TRANSLATE_NOOP("ObjectProperty", "vertexes"), QT_TR_NOOP("m"), QT_TR_NOOP("Vertex list"), vertexes, setVertexes))
...
STEPCORE_META_OBJECT(Plane, QT_TRANSLATE_NOOP("ObjectClass", "Plane"), QT_TR_NOOP("Unmovable rigid plane"), 0, STEPCORE_SUPER_CLASS(Item) STEPCORE_SUPER_CLASS(Body),
        STEPCORE_PROPERTY_RW_D(StepCore::Vector2d, point1, QT_TRANSLATE_NOOP("ObjectProperty", "point1"), QT_TR_NOOP("m"), QT_TR_NOOP("First point which defines the plane"), point1, setPoint1),
        STEPCORE_PROPERTY_RW_D(StepCore::Vector2d, point2, QT_TRANSLATE_NOOP("ObjectProperty", "point2"), QT_TR_NOOP("m"), QT_TR_NOOP("Second point which defines the plane"), point2, setPoint2))
#endif
