...
STEPCORE_META_OBJECT(CoulombForce, QT_TRANSLATE_NOOP("ObjectClass", "CoulombForce"), QT_TR_NOOP("Coulomb force"), 0,
    ...
    STEPCORE_PROPERTY_RW(double, coulombConst, QT_TRANSLATE_NOOP("ObjectProperty", "coulombConst"), STEPCORE_FROM_UTF8("N m²/C²"),
...
STEPCORE_META_OBJECT(CoulombForceErrors, QT_TRANSLATE_NOOP("ObjectClass", "CoulombForceErrors"), QT_TR_NOOP("Errors class for CoulombForce"), 0,
    ...
    STEPCORE_PROPERTY_RW(double, coulombConstVariance, QT_TRANSLATE_NOOP("ObjectProperty", "coulombConstVariance"), STEPCORE_FROM_UTF8("N m²/C²"),
