...
if(QALCULATE_CFLAGS AND QALCULATE_LIBRARIES)
  ...
  if(QALCULATE_FOUND)
    if(NOT QALCULATE_FIND_QUIETLY)
      message(STATUS "Found libqalculate: ${QALCULATE_LIBRARIES}")
    endif(NOT QALCULATE_FIND_QUIETLY)
  else(QALCULATE_FOUND)
    if(QALCULATE_FIND_REQUIRED)
      message(FATAL_ERROR "Could NOT find libqalculate")
    endif(QALCULATE_FIND_REQUIRED)
